...
# run in terminal : pip install urllib3==1.26.15 and then pip install --upgrade pip

# error :
# equests.exceptions.InvalidSchema: Missing dependencies for SOCKS support.
# run in terminal : "unset all_proxy" and "unset ALL_PROXY" and then pip install pysocks
...
def torSearcher(url):
    ...
    with open("forum.txt", "w+", encoding="utf-8") as newthing:
